...
open class JKDefaultView: UIView {
    ...
    override init (frame : CGRect) {
        ...
        textLabel = UILabel(frame: CGRect(x: textLabelX, y: horizontalSpace, width: frame.width - textLabelX - 2 * horizontalSpace, height: 26))
    ...
    //MARK: This is For Background Color of View
    ...
    open func setPanelStatus(_ status:JKStatus) {
        ...
        case .success:
            ...
            baseView.backgroundColor =  UIColor(red: 230.0/255.0, green: 42.0/255.0, blue: 114.0/255.0, alpha: 1)
        case .warning:
            imageIcon.image = loadImageBundle(named: "warning-icon")
            textLabel.text = "Warning"
            baseView.backgroundColor = UIColor(named: "348FE6")//UIColor(red: 230.0/255.0, green: 42.0/255.0, blue: 114.0/255.0, alpha: 1)
        case .failed:
