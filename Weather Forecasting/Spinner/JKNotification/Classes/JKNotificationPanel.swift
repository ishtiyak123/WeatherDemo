...
open class JKNotificationPanel: NSObject {
    ...
    open func showNotify(withStatus status: JKStatus, belowNavigation navigation: UINavigationController, title:String? = nil , message:String? = nil) {
        ...
        //  verticalSpace = navigation.navigationBar.frame.size.height + UIApplication.shared.statusBarFrame.size.height //This is Working fine When Navigation in present on the Screen
        
         verticalSpace = UIApplication.shared.statusBarFrame.size.height
        // This is working fine When no Navigation in the screen
