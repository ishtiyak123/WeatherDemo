...
#define themeYellow [UIColor colorWithRed:28.0/255.0 green:19.0/255.0 blue:90.0/255.0 alpha:1]
...
- (id)init
{
	if (self = [super init]) {
		...
		_circleStrokeForegroundColor = themeYellow;
		...
		_circleSize = (_fullScreen) ? 90.0f : 35.0f;
		_stopRelativeHeight = 0.3;
		_lineWidth = 1.0f;
		
		_statusColor = [UIColor blackColor];
        _statusFont = [UIFont systemFontOfSize:15.0f weight:UIFontWeightThin]; //[UIFont fontWithName:@"HelveticaNeue-Thin" size:14.0f];
		
		_successColor = themeYellow;
		_errorColor = themeYellow;
